...
def get_key_constraint_statement(con,table_name):
    ...
    merged_list = fetch_merged_condes_connames_list(connames,condefs)
...
def fetch_merged_condes_connames_list(connames,condefs):
    key_constraint_list = []
